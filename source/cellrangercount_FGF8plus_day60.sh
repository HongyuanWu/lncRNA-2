...
# INPUT PARAMS
#############################################################
TRANSCRIPTOME_DIR="/path to your bam/possorted_REferencegenome"
PROJECT="FGF8plus_day60"
SAMPLE="FGF8plus_day60"
#PROJECTNAME="10XscAle"
#############################################################
# OUTPUT PARAMS
#############################################################
CELLRANGER_ID=$SAMPLE"_V3"
FASTQ_PATH="/path to your fatqfiles"
#############################################################
